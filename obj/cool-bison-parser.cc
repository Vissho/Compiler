...
#line 120 "obj/cool-bison-parser.cc"
...
#line 112 "src/cool.bison"
                     {  (yyloc) = (yylsp[0]); ast_root = program((yyvsp[0].classes)); }
#line 1397 "obj/cool-bison-parser.cc"
    break;

  case 3: /* class_list: class  */
#line 118 "src/cool.bison"
  { (yyval.classes) = single_Classes((yyvsp[0].class_)); parse_results = (yyval.classes); }
#line 1403 "obj/cool-bison-parser.cc"
    break;

  case 4: /* class_list: class_list class  */
#line 120 "src/cool.bison"
  { (yyval.classes) = append_Classes((yyvsp[-1].classes), single_Classes((yyvsp[0].class_))); parse_results = (yyval.classes); }
#line 1409 "obj/cool-bison-parser.cc"
    break;

  case 5: /* class_list: error ';' class  */
#line 122 "src/cool.bison"
  { (yyval.classes) = single_Classes((yyvsp[0].class_)); yyerrok; }
#line 1415 "obj/cool-bison-parser.cc"
    break;

  case 6: /* class: CLASS TYPEID '{' feature_list '}' ';'  */
#line 129 "src/cool.bison"
  { (yyval.class_) = class_((yyvsp[-4].symbol), idtable.add_string("Object"), (yyvsp[-2].features), stringtable.add_string(curr_filename)); }
#line 1421 "obj/cool-bison-parser.cc"
    break;

  case 7: /* class: CLASS TYPEID INHERITS TYPEID '{' feature_list '}' ';'  */
#line 131 "src/cool.bison"
  { (yyval.class_) = class_((yyvsp[-6].symbol), (yyvsp[-4].symbol), (yyvsp[-2].features), stringtable.add_string(curr_filename)); }
#line 1427 "obj/cool-bison-parser.cc"
    break;

  case 8: /* feature_list: %empty  */
#line 137 "src/cool.bison"
  { (yyval.features) = nil_Features(); }
#line 1433 "obj/cool-bison-parser.cc"
    break;

  case 9: /* feature_list: feature_list feature  */
#line 139 "src/cool.bison"
  { (yyval.features) = append_Features((yyvsp[-1].features), single_Features((yyvsp[0].feature))); }
#line 1439 "obj/cool-bison-parser.cc"
    break;

  case 10: /* feature: OBJECTID ':' TYPEID optional_assign ';'  */
#line 144 "src/cool.bison"
  { (yyval.feature) = attr((yyvsp[-4].symbol), (yyvsp[-2].symbol), (yyvsp[-1].expression)); }
#line 1445 "obj/cool-bison-parser.cc"
    break;

  case 11: /* feature: OBJECTID '(' formal_list ')' ':' TYPEID '{' expr '}' ';'  */
#line 146 "src/cool.bison"
  { (yyval.feature) = method((yyvsp[-9].symbol), (yyvsp[-7].formals), (yyvsp[-4].symbol), (yyvsp[-2].expression)); }
#line 1451 "obj/cool-bison-parser.cc"
    break;

  case 12: /* feature: error ';'  */
#line 147 "src/cool.bison"
            {}
#line 1457 "obj/cool-bison-parser.cc"
    break;

  case 13: /* formal_list: %empty  */
#line 152 "src/cool.bison"
  { (yyval.formals) = nil_Formals(); }
#line 1463 "obj/cool-bison-parser.cc"
    break;

  case 14: /* formal_list: formal  */
#line 154 "src/cool.bison"
  { (yyval.formals) = single_Formals((yyvsp[0].formal)); }
#line 1469 "obj/cool-bison-parser.cc"
    break;

  case 15: /* formal_list: formal_list ',' formal  */
#line 156 "src/cool.bison"
  { (yyval.formals) = append_Formals((yyvsp[-2].formals), single_Formals((yyvsp[0].formal))); }
#line 1475 "obj/cool-bison-parser.cc"
    break;

  case 16: /* formal: OBJECTID ':' TYPEID  */
#line 161 "src/cool.bison"
  { (yyval.formal) = formal((yyvsp[-2].symbol), (yyvsp[0].symbol)); }
#line 1481 "obj/cool-bison-parser.cc"
    break;

  case 17: /* expr_list_comma: %empty  */
#line 166 "src/cool.bison"
  { (yyval.expressions) = nil_Expressions(); }
#line 1487 "obj/cool-bison-parser.cc"
    break;

  case 18: /* expr_list_comma: expr  */
#line 168 "src/cool.bison"
  { (yyval.expressions) = single_Expressions((yyvsp[0].expression)); }
#line 1493 "obj/cool-bison-parser.cc"
    break;

  case 19: /* expr_list_comma: expr_list_comma ',' expr  */
#line 170 "src/cool.bison"
  { (yyval.expressions) = append_Expressions((yyvsp[-2].expressions), single_Expressions((yyvsp[0].expression))); }
#line 1499 "obj/cool-bison-parser.cc"
    break;

  case 20: /* expr_list_simicolon: expr ';'  */
#line 175 "src/cool.bison"
  { (yyval.expressions) = single_Expressions((yyvsp[-1].expression)); }
#line 1505 "obj/cool-bison-parser.cc"
    break;

  case 21: /* expr_list_simicolon: expr_list_simicolon expr ';'  */
#line 177 "src/cool.bison"
  { (yyval.expressions) = append_Expressions((yyvsp[-2].expressions), single_Expressions((yyvsp[-1].expression))); }
#line 1511 "obj/cool-bison-parser.cc"
    break;

  case 22: /* expr_list_simicolon: error ';'  */
#line 178 "src/cool.bison"
            { yyerrok; }
#line 1517 "obj/cool-bison-parser.cc"
    break;

  case 23: /* expr: STR_CONST  */
#line 183 "src/cool.bison"
  { (yyval.expression) = string_const((yyvsp[0].symbol)); }
#line 1523 "obj/cool-bison-parser.cc"
    break;

  case 24: /* expr: INT_CONST  */
#line 185 "src/cool.bison"
  { (yyval.expression) = int_const((yyvsp[0].symbol)); }
#line 1529 "obj/cool-bison-parser.cc"
    break;

  case 25: /* expr: BOOL_CONST  */
#line 187 "src/cool.bison"
  { (yyval.expression) = bool_const((yyvsp[0].boolean)); }
#line 1535 "obj/cool-bison-parser.cc"
    break;

  case 26: /* expr: OBJECTID  */
#line 189 "src/cool.bison"
  { (yyval.expression) = object((yyvsp[0].symbol)); }
#line 1541 "obj/cool-bison-parser.cc"
    break;

  case 27: /* expr: OBJECTID ASSIGN expr  */
#line 191 "src/cool.bison"
  { (yyval.expression) = assign((yyvsp[-2].symbol), (yyvsp[0].expression)); }
#line 1547 "obj/cool-bison-parser.cc"
    break;

  case 28: /* expr: expr '.' OBJECTID '(' expr_list_comma ')'  */
#line 194 "src/cool.bison"
  { (yyval.expression) = dispatch((yyvsp[-5].expression), (yyvsp[-3].symbol), (yyvsp[-1].expressions)); }
#line 1553 "obj/cool-bison-parser.cc"
    break;

  case 29: /* expr: OBJECTID '(' expr_list_comma ')'  */
#line 196 "src/cool.bison"
  { (yyval.expression) = dispatch(object(idtable.add_string("self")), (yyvsp[-3].symbol), (yyvsp[-1].expressions)); }
#line 1559 "obj/cool-bison-parser.cc"
    break;

  case 30: /* expr: expr '@' TYPEID '.' OBJECTID '(' expr_list_comma ')'  */
#line 198 "src/cool.bison"
  { (yyval.expression) = static_dispatch((yyvsp[-7].expression), (yyvsp[-5].symbol), (yyvsp[-3].symbol), (yyvsp[-1].expressions)); }
#line 1565 "obj/cool-bison-parser.cc"
    break;

  case 31: /* expr: IF expr THEN expr ELSE expr FI  */
#line 201 "src/cool.bison"
  { (yyval.expression) = cond((yyvsp[-5].expression), (yyvsp[-3].expression), (yyvsp[-1].expression)); }
#line 1571 "obj/cool-bison-parser.cc"
    break;

  case 32: /* expr: '{' expr_list_simicolon '}'  */
#line 204 "src/cool.bison"
  { (yyval.expression) = block((yyvsp[-1].expressions)); }
#line 1577 "obj/cool-bison-parser.cc"
    break;

  case 33: /* expr: let_expr  */
#line 207 "src/cool.bison"
  { (yyval.expression) = (yyvsp[0].expression); }
#line 1583 "obj/cool-bison-parser.cc"
    break;

  case 34: /* expr: CASE expr OF case_list ESAC  */
#line 209 "src/cool.bison"
  { (yyval.expression) = typcase((yyvsp[-3].expression), (yyvsp[-1].cases)); }
#line 1589 "obj/cool-bison-parser.cc"
    break;

  case 35: /* expr: NEW TYPEID  */
#line 212 "src/cool.bison"
  { (yyval.expression) = new_((yyvsp[0].symbol)); }
#line 1595 "obj/cool-bison-parser.cc"
    break;

  case 36: /* expr: ISVOID expr  */
#line 215 "src/cool.bison"
  { (yyval.expression) = isvoid((yyvsp[0].expression)); }
#line 1601 "obj/cool-bison-parser.cc"
    break;

  case 37: /* expr: expr '+' expr  */
#line 218 "src/cool.bison"
  { (yyval.expression) = plus((yyvsp[-2].expression), (yyvsp[0].expression)); }
#line 1607 "obj/cool-bison-parser.cc"
    break;

  case 38: /* expr: expr '-' expr  */
#line 220 "src/cool.bison"
  { (yyval.expression) = sub((yyvsp[-2].expression), (yyvsp[0].expression)); }
#line 1613 "obj/cool-bison-parser.cc"
    break;

  case 39: /* expr: expr '*' expr  */
#line 222 "src/cool.bison"
  { (yyval.expression) = mul((yyvsp[-2].expression), (yyvsp[0].expression)); }
#line 1619 "obj/cool-bison-parser.cc"
    break;

  case 40: /* expr: expr '/' expr  */
#line 224 "src/cool.bison"
  { (yyval.expression) = divide((yyvsp[-2].expression), (yyvsp[0].expression)); }
#line 1625 "obj/cool-bison-parser.cc"
    break;

  case 41: /* expr: '~' expr  */
#line 226 "src/cool.bison"
  { (yyval.expression) = neg((yyvsp[0].expression)); }
#line 1631 "obj/cool-bison-parser.cc"
    break;

  case 42: /* expr: expr '<' expr  */
#line 228 "src/cool.bison"
  { (yyval.expression) = lt((yyvsp[-2].expression), (yyvsp[0].expression)); }
#line 1637 "obj/cool-bison-parser.cc"
    break;

  case 43: /* expr: expr '=' expr  */
#line 230 "src/cool.bison"
  { (yyval.expression) = eq((yyvsp[-2].expression), (yyvsp[0].expression)); }
#line 1643 "obj/cool-bison-parser.cc"
    break;

  case 44: /* expr: expr LE expr  */
#line 232 "src/cool.bison"
  { (yyval.expression) = leq((yyvsp[-2].expression), (yyvsp[0].expression)); }
#line 1649 "obj/cool-bison-parser.cc"
    break;

  case 45: /* expr: NOT expr  */
#line 234 "src/cool.bison"
  { (yyval.expression) = comp((yyvsp[0].expression)); }
#line 1655 "obj/cool-bison-parser.cc"
    break;

  case 46: /* expr: '(' expr ')'  */
#line 237 "src/cool.bison"
  { (yyval.expression) = (yyvsp[-1].expression); }
#line 1661 "obj/cool-bison-parser.cc"
    break;

  case 47: /* expr: WHILE expr LOOP expr POOL  */
#line 240 "src/cool.bison"
  { (yyval.expression) = loop((yyvsp[-3].expression), (yyvsp[-1].expression)); }
#line 1667 "obj/cool-bison-parser.cc"
    break;

  case 48: /* case_list: %empty  */
#line 245 "src/cool.bison"
  { (yyval.cases) = nil_Cases(); }
#line 1673 "obj/cool-bison-parser.cc"
    break;

  case 49: /* case_list: case_list case  */
#line 247 "src/cool.bison"
  { (yyval.cases) = append_Cases((yyvsp[-1].cases), single_Cases((yyvsp[0].case_))); }
#line 1679 "obj/cool-bison-parser.cc"
    break;

  case 50: /* case: OBJECTID ':' TYPEID DARROW expr ';'  */
#line 252 "src/cool.bison"
  { (yyval.case_) = branch((yyvsp[-5].symbol), (yyvsp[-3].symbol), (yyvsp[-1].expression)); }
#line 1685 "obj/cool-bison-parser.cc"
    break;

  case 51: /* let_expr: LET let_binding_list IN expr  */
#line 257 "src/cool.bison"
  {
